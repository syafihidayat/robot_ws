...
def generate_launch_description():
    sensors_launch_path = PathJoinSubstitution(
        [FindPackageShare('lbringup'), 'launch', 'sensors.launch.py']
    )

    joy_launch_path = PathJoinSubstitution(
        [FindPackageShare('lbringup'), 'launch', 'joy_teleop.launch.py']
    )
    ...
    ekf_config_path = PathJoinSubstitution(
        [FindPackageShare("lbringup"), "config", "ekf.yaml"]
    )

    default_robot_launch_path = PathJoinSubstitution(
        [FindPackageShare('lbringup'), 'launch', 'default_robot.launch.py']
    )

    custom_robot_launch_path = PathJoinSubstitution(
        [FindPackageShare('lbringup'), 'launch', 'custom_robot.launch.py']
    )

    extra_launch_path = PathJoinSubstitution(
        [FindPackageShare('lbringup'), 'launch', 'extra.launch.py']
    )
    
    twist_mux_params = PathJoinSubstitution(
        [FindPackageShare('lbringup'), 'config', 'twist_mux.yaml']
    )
