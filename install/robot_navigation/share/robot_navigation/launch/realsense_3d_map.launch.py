...
def generate_launch_description():
    ...
    remappings_real_robot = [
          ('imu', '/imu/data'),
          ('rgb/image', '/camera/realsense2_camera/infra1/image_rect_raw'),
          ('rgb/camera_info', '/camera/realsense2_camera/infra1/camera_info'),
          ('depth/image', '/camera/realsense2_camera/depth/image_rect_raw')
    ]
